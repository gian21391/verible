...
class LinterConfiguration {
 public:
  ...
  void UseProjectPolicy(const ProjectPolicy &policy, std::string_view filename);
  ...
  absl::Status AppendFromFile(std::string_view filename);
